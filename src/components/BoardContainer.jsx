...
class BoardContainer extends Component {
  ...
  render() {
    ...
    const boradContainerProps = Object.keys(otherProps).reduce((acc, key) => {
      if (key in div) {
    ...
    return (
      <BoardDiv style={style} {...boradContainerProps} draggable={false}>
        <Container
        ...
        >
          {reducerData.lanes.map((lane, index) => {
            ...
            return draggable && laneDraggable && (lane.movable === undefined ? true : lane.movable) ? (
